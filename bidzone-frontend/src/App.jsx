...
const App = () => {
  ...
  return (
    ...
    <Routes>
      ...
      <Route path="/messages/:userName" element={<Message cart={cart} setCart={setCart} setData={setData}/>} />
      <Route path="/chat/:userName/:sender" element={<ChatPage cart={cart} setCart={setCart} setData={setData}/>} />
    </Routes>
